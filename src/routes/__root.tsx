...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Craftfolio AI — Build Your Career Presence, Not Just Your Resume" },
      ...
      { property: "og:description", content: "Resumes, portfolios, cover letters, and job tracking — built for the next generation of professionals." },
